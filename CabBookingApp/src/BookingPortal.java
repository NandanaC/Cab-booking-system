...
public class BookingPortal {
	...
	private void initialize() {
		...
		JComboBox<String> comboBox_1 = new JComboBox<>(s);
		...
		Image map = new ImageIcon(this.getClass().getResource("/bangalore-india.jpg")).getImage();
		...
		btnSearchForCabs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double x1 = SqlConnector.getX(from);
				double y1 = SqlConnector.getY(from);
				double x2 = SqlConnector.getX(to);
				double y2 = SqlConnector.getY(to);
