...
public class Login {
	...
	private void initialize() {
		...
		ImageIcon logo = new ImageIcon(this.getClass().getResource("/logo1.png"));
		...
		JLabel lblWelcomeToUber = DefaultComponentFactory.getInstance().createTitle("Welcome to Skyway Cabs");
		lblWelcomeToUber.setForeground(Color.BLACK);
		lblWelcomeToUber.setFont(new Font("Tahoma", Font.BOLD, 32));
		...
		label_4.setBounds(0, 0, 1162, 841);
		frame.getContentPane().add(label_4);
		Image bg = new ImageIcon(this.getClass().getResource("/loginBackground1.png")).getImage();
