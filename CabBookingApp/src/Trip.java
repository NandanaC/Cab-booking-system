...
public class Trip {
	...
	private void initialize() {
		...
		ImageIcon logo = new ImageIcon("C:\\Users\\Hp\\Downloads\\CabBookingApp-master\\CabBookingApp-master\\images\\logo.png");
		frame.setIconImage(logo.getImage());
		frame.setTitle("Skyway Cabs");
		...
		JComboBox<String> comboBox = new JComboBox<>(ratingOptions);
			...
			public void actionPerformed(ActionEvent e) {
				...
				btnOk.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
	            		...
	            		SqlConnector.DBConnectupdateDriver("update driver set tripcount="+Integer.toString(d1.tripsCount+1)+",rating=" + Double.toString((recentRating + d1.rating*(d1.tripsCount))/(d1.tripsCount+1))+",availability='Yes',presentloc='"+newcity+"' where vehicleno='"+d1.vehicleNo+"';" );
